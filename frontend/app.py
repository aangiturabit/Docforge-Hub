...
#         # ── Filters: Department + Document Type only (no Status filter) ───────
#         f1, f2 = st.columns(2)
...
#                         with info_col:
#                             st.markdown(f"**{title}**")
#                             # ── Date + version only (no status dot) ──────────
            ...
            # ── FULL GENERATED DOCUMENT (editable) ───────────────────────────
                ...
                if sections:
                    for sec_idx, section in enumerate(sections):
                        ...
                        # Use index-based key — guarantees uniqueness even when
                        # two section headings truncate to the same string.
                        rkey = f"sec_{sec_idx}"
